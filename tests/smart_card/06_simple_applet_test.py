...
isd.apdu_plain('00A4 0400' + lv_hex('A00000008253696D706C65'), expected_sw=0x9000, name='SELECT: SimpleApplet')
isd.apdu_plain('0002 0000' + lv_hex('1122334455'), expected_sw=0x9000, name='XOR input')
